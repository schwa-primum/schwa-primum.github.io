...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "bio",
          description: "You can download my CV.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%6A%6F%72%64%6A%65.%62%6F%7A@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-3028-5441", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://facebook.com/gjorgje.bozhoviq", "_blank");
        },
      },{
      id: 'light-theme',
